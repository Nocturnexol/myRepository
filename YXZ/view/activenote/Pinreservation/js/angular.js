 ...
 *
 * The above creates an instance of minErr in the example images. The
 * resulting error will have a imagesd error code of example.one.  The
 ...
 * Instances should have names of the form imagesMinErr for a minErr created
 * using minErr('images') . Error codes, namespaces and template strings
